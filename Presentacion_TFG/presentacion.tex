        ...
        \begin{column}{0.50\textwidth}
            ...
            \begin{columns}[c]
                \begin{column}{0.49\textwidth}
                    ...
                    \begin{figure}
                        \includegraphics[width=0.5\linewidth, keepaspectratio]{imagenes/Otter.ai.png}
                    \end{figure}
                \end{column}
                \begin{column}{0.49\textwidth}
                    \centering
                    ...
                    \begin{figure}
                        \includegraphics[width=0.5\linewidth, keepaspectratio]{imagenes/Fireflies.ai.png}
                    \end{figure}
                \end{column}
            \end{columns}
        \end{column}
...
\begin{frame}{Spec-Driven Development -- Parte 2}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.80\linewidth, keepaspectratio]{imagenes/JustColbPowers.png}
