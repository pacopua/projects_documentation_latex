...
\begin{frame}{Spec-Driven Development -- \textit{colbPowers}}
    \begin{columns}[T]
        \begin{column}{0.50\textwidth}
            ...
            \end{itemize}
            \vspace{0.3cm}
            \textbf{Estructura del repositorio:}\\[0.2cm]
        ...
        \begin{column}{0.47\textwidth}
            \normalsize
            Compatible con \textbf{OpenCode} y \textbf{ClaudeCode}:
            \vspace{0.2cm}
            \begin{columns}[T]
                \begin{column}{0.50\textwidth}
                    \begin{figure}
                        \includegraphics[width=\linewidth, keepaspectratio]{imagenes/ClaudeCodeIcon.png}
                    \end{figure}
                \end{column}
                \begin{column}{0.50\textwidth}
                    \begin{figure}
                        \includegraphics[width=\linewidth, keepaspectratio]{imagenes/OpenCodeIcon.png}
                    \end{figure}
                \end{column}
            \end{columns}
            \vspace{0.2cm}
...
\begin{frame}{Conclusiones}
    ...
    \begin{itemize}
        ...
        \vspace{0.1cm}
        \item \textbf{Caso 1 (repo existente)}: mayor complejidad ciclomática con colbPowers; sin mejora neta en mantenibilidad. Los agentes apenas invocaron \textit{code-review-graph}.
        \vspace{0.1cm}
    ...
    \end{itemize}
    \vspace{0.15cm}
    En producción en \textit{Colb.AI} la valoración del sistema ha sido \textbf{positiva} desde su adopción.
\end{frame}
