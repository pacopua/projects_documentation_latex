...
\begin{frame}{Propuesta conceptual}
    \begin{columns}[T]
        ...
        \begin{column}{0.57\textwidth}
            \begin{figure}
                \includegraphics[width=0.7\linewidth, keepaspectratio]{imagenes/HumanInTheLoop_AND_SpecDrivenDevelopment.png}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Spec-Driven Development -- Flujo de \textit{colbPowers}}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.82\linewidth, keepaspectratio]{imagenes/JustColbPowers.png}
...
\begin{frame}{Conclusiones -- Resultados experimentales}
    ...
    \vspace{0.1cm}
    \begin{itemize}
        \item \textbf{Caso 2 (proyecto nuevo) con OpenCode}: $-$27\% complejidad ciclomática, $+$15\% índice de mantenibilidad ($p < 0{,}05$, efecto grande). \textcolor{green!70!black}{Hipótesis confirmada.}
        \vspace{0.05cm}
...
\begin{frame}{Trabajo futuro}
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                \footnotesize
                \item \textbf{Memoria acumulativa} entre reuniones mediante base de datos vectorial.
                \vspace{0.1cm}
                \item \textbf{RAG} para estimaciones de presupuesto basadas en proyectos anteriores de \textit{Colb.AI}.
                \vspace{0.1cm}
