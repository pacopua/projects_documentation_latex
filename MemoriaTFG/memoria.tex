...
Es innegable que las herramientas de inteligencia artificial, principalmente los \textit{Large Language Models}, están cambiando la forma en que se desarrollan los proyectos de software para la mayor parte de empresas del sector \cite{jetbrains_deveco_2025}. Estas tecnologías presentan la oportunidad de automatizar muchas de las tareas que tradicionalmente habían sido llevadas a cabo exclusivamente por los desarrolladores humanos, pero su adopción sin la supervisión humana adecuada conlleva riesgos que pueden comprometer la calidad y sostenibilidad del software generado, sobre todo a largo plazo.
...
\begin{itemize}
    \item \textbf{Generación de \textit{slop code}:} El código producido resuelve el problema inmediato, pero carece de estructura coherente, no sigue los estándares del proyecto y acumula deuda técnica \cite{cunningham_1992_techdebt}. En \cite{pearce2022asleep} se evaluó empíricamente este fenómeno generando más de 1.600 programas con GitHub Copilot, y se encontró que aproximadamente el 40\% contenía vulnerabilidades de seguridad, poniendo de manifiesto los riesgos de delegar la generación de código a agentes de IA sin una estructura de supervisión adecuada. Al no haber una especificación de referencia, el modelo no puede saber qué es correcto más allá de lo que el usuario describe en ese momento. El resultado es un código difícil de mantener, escalar o auditar.
...
Aunque existen herramientas que sí exigen especificación previa como Spec Kit o AgentOS, estas no se adaptaban adecuadamente al flujo de trabajo de \textit{Colb.AI}, su modelo de documentación era demasiado rígido y generaba una fricción excesiva incluso para cambios menores.
...
\begin{enumerate}
    ...
    \item \textbf{Módulo de seguimiento del cliente}: automatiza la generación de documentación post-reunión en el formato específico de \textit{Colb.AI}, disponible como skill de Claude Cowork y como implementación propia de código abierto con python-docx.
\end{enumerate}
