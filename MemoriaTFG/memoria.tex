...
\textit{Análisis estadístico.} Se utiliza el test $t$ de Welch para comparar las medias de cada métrica entre condiciones, en lugar del $t$ de Student, dado que no se puede asumir igualdad de varianzas entre grupos. Como estimador del tamaño del efecto se emplea la $g$ de Hedges \cite{Hedges}, que corrige el sesgo de la $d$ de Cohen en muestras pequeñas.
