...
\begin{itemize}
    ...
    \item \textbf{Probabilidad y estadística (PE):} Disponer de una base en probabilidad y estadística ha sido de utilidad en la sección de experimentación, donde se aplican contrastes de hipótesis y estimadores del tamaño del efecto para interpretar los resultados obtenidos. Sin los fundamentos de esta asignatura, razonar sobre conceptos como significación estadística, potencia o tamaño muestral habría resultado considerablemente más difícil.
