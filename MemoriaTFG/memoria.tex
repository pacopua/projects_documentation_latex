...
Con la disponibilidad de las nuevas herramientas de inteligencia artificial basadas en modelos de lenguaje, está habiendo una revolución en la forma en que desarrollamos proyectos de software. Gracias a estas herramientas, se presenta la oportunidad de automatizar muchas de las tareas que tradicionalmente habian sido llevadas a cabo exclusivamente por los desarrolladores. Sin embargo, la implementación sin un plan premeditado de estas herramientas, en muchas ocasiones ha llevado a problemas que hacen la aplicación de estas herramientas una deuda técnica más que una ayuda real, consiguiendo resultados muy rapidos al inicio de un proyecto, pero teniendo una muy mala escalabilidad y mantenibilidad a largo plazo.

Lo que se busca en concreto con este proyecto, es ahorrar tiempo y recursos de la empresa, automatizando al máximo las principales etapas contenidas en el ciclo de vida del desarrollo de un proyecto software.
...
El principal problema que tenemos que se presenta en la automatización de estas tareas, sin perder calidad, es conseguir un equilibrio entre la agilidad que ofrecen los asistentes de inteligencia artificial, y la involucración de un desarrollador que garantice que cada paso cubre con unos estándares de estructura y calidad.

Para esto, haremos mención a una temática discutida en el ambito de la neurología. \textit{ "The law of least effort"}, en otras palabras, la ley del minimo esfuerzo, es una teoria que dice que los humanos y otros organismos tienden a priorizar la opción que presenta la menor resistencia para alcanzar sus objetivos, sea por un esfuerzo físico o cognitivo. Aunque es ciertamente paradógico, puesto que a las personas nos gustas cosas como puzles y rompecabezas \cite{inzlicht_effort_paradox_2018}, creo que es el principal problema de la automatización de tareas, el desarrollador tiene la tentación de dejar que el asistente de IA haga todo el trabajo, sin involucrarse lo suficiente para garantizar que el resultado cumple con los estándares de calidad y estructura necesarios para un proyecto profesional y sostenible a largo plazo.
...
Este apartado se considera especialmente relevante en lo que es el ambito de la consultoría, debido a que la relación y involucramiento con el cliente es una componente esencia para conseguir que un proyecto de software progrese adecuadamente. En este sentido, la automatización de esta fase tiene el riesgo de que la información que se transmite al cliente no sea clara, o directamente sea incorrecta.
