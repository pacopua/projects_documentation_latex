...
\begin{description}
    ...
    \item[\textbf{Seguimiento del cliente:}] Automatizar la generación de documentación de seguimiento post-reunión, produciendo de forma estructurada el resumen de lo acordado y los próximos pasos para ambas partes, a partir de la transcripción de las reuniones periódicas con el cliente.
\end{description}
