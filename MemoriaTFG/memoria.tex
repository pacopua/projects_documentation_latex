...
Es innegable que las herramientas de inteligencia artificial, principalmente los grandes modelos de lenguaje (\textit{LLMs}), están cambiando la forma en que se desarrollan los proyectos de software en la mayor parte de las empresas del sector. Estas tecnologías presentan la oportunidad de automatizar muchas de las tareas que tradicionalmente habían sido llevadas a cabo exclusivamente por los desarrolladores humanos, aunque su adopción sin la supervisión humana adecuada conlleva riesgos que pueden comprometer la calidad y sostenibilidad del software a largo plazo.
...
La toma de requerimientos es una fase especialmente crítica en el desarrollo de software, puesto que sienta las bases del proyecto: su alcance, las tecnologías a utilizar y la arquitectura del sistema. Las necesidades del cliente se expresan habitualmente en conversaciones informales, y transformarlas en un documento de especificación completo, coherente y estructurado requiere hoy un esfuerzo manual significativo. Si esta fase no se lleva a cabo con el adecuado rigor, puede traer consecuencias muy graves para el resto del desarrollo. Sin embargo, no existe actualmente ninguna herramienta que, a partir de la transcripción de una reunión con el cliente, sea capaz de explorar de forma autónoma las tecnologías relevantes y producir un plan de implementación inicial listo para incorporarse al repositorio, manteniendo siempre al desarrollador en el control del proceso.

\subsubsection{Desarrollo de código}
\label{sec:ProblemaDesarrolloCodigo}

\textbf{El problema es la inexistencia de una solución de asistencia al desarrollo que equilibre la agilidad de las herramientas \textit{Code-Driven} con la rigurosidad estructural que exige el desarrollo de software profesional y sostenible.}
...
Este apartado se considera especialmente relevante en el ámbito de la consultoría, debido a que la relación y el involucramiento con el cliente son una componente esencial para que un proyecto de software progrese adecuadamente. Cada reunión de seguimiento genera la necesidad de producir un documento estructurado que recoja los temas tratados, las decisiones tomadas y los próximos pasos para ambas partes. Este documento se elabora hoy de forma manual, lo que introduce latencia y variabilidad en el formato según quién lo redacte. Las herramientas comerciales existentes (Otter.ai, Fireflies, Microsoft Copilot for Teams) generan resúmenes genéricos, pero no producen la documentación estructurada con el formato específico que cada empresa de consultoría requiere, ni permiten parametrizar la salida en función del tipo de reunión o del cliente.
