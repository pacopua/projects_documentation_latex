...
En esta sección del trabajo se declaran los objetivos del proyecto, cuales son los requerimientos para dar este objetivo por cumplido, las métricas que se utilizarán para evaluar el sistema, y los posibles obstáculos y riesgos que pueden aparecer en el desarrollo del proyecto (Tal y como pide la metodología de \textit{GEP}). Adicionalmente, se ha añadido un último subapartado destacando la evolución que ha tenido este proyecto respecto la planificación inicial de \textit{GEP}.
