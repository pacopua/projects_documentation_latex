...
\begin{itemize}
    ...
    \item Se le ha de ofrecer al desarrollador métricas para analizar la calidad y la estructura del código generado. Las métricas utilizadas serán: \textit{Complejidad Ciclomática}\cite{McCabe_Complexity} del código, y el Índice de Sostenibilidad del Código.
