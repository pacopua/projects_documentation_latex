...
\begin{table}[H]
    ...
    \begin{tabular}{l c}
         ...
         \midrule
         \textbf{Coste de Personal} (GP, TP, DA, PV) & 10.262,02€ \\
         \textbf{Costes Genéricos} (Estructurales, Software, Hardware) & 1.488,07€ \\
         \midrule
         \textbf{Subtotal (Base del proyecto)} & \textbf{11.750,09€} \\
         \midrule
         \textbf{Contingencias} (15\% sobre el Subtotal) & 1.762,52€ \\
         \textbf{Imprevistos} (Riesgos evaluados) & 587,20€ \\
         \midrule
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{imagenes/SeguimientDelCliente.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{imagenes/CicloSesiónOpenCode.png}
...
\midrule
\textbf{baseline} & Ejec.~1 & 3,67 & 1,15 & 0,02 & 2,49 & 74 & 0 \\
...
\midrule
\textbf{colbPowers} & Ejec.~1 & 10,64 & 5,40 & 0,07 & 5,15 & 108 & 0 \\
...
\textbf{Condición} & \textbf{Ejecución} & \textbf{Total (M)} & \textbf{Input (M)} & \textbf{Output (M)} & \textbf{Caché (M)} & \textbf{Tool calls} & \textbf{CRG} \\
\midrule
\textbf{baseline} & Ejec.~1 & 6,64 & 0,01 & 0,04 & 6,50 & 76 & 0 \\
...
\midrule
\textbf{colbPowers} & Ejec.~1 & 12,23 & 0,00 & 0,11 & 11,66 & 56 & 0 \\
