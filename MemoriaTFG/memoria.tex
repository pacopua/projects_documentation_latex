...
\begin{itemize}
    \item \textbf{Compresión de datos e imagenes (CDI):} Para el tema de el audio
    \item \textbf{Busqueda y analisis de información masiva (CAIM):} Para lo de tavily, lo del chunking para el primer apartado... Y todo lo de information Retrieval.
    \item \textbf{Introducción a la ingeniería del software (IES):} Para el diseño del sistema y de los diagrama de flujo y datos.
\end{itemize}
