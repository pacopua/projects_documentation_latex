...
\begin{enumerate}
    ...
    \item \textbf{Ejecución iterativa con implementador y revisor:} el agente utiliza la herramienta de lista de tareas (\texttt{TodoWrite}) integrada en los asistentes CLI para ejecutar el plan de forma iterativa. Para cada tarea, actúa un subagente implementador que escribe el código, y a continuación un subagente revisor que verifica que el código se ajusta a la especificación, sigue el plan y pasa los tests definidos.\end{enumerate}
...
\paragraph{Limitaciones del diseño experimental.} Deben señalarse tres limitaciones estructurales.
\begin{enumerate}
