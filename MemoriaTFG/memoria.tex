...
Para esto, haremos mención a una temática discutida en el ambito de la neurología. \textit{ "The law of least effort"}, en otras palabras, la ley del minimo esfuerzo, es una teoria que dice que los humanos y otros organismos tienden a elegir la opción que requiere el menor esfuerzo para alcanzar sus objetivos, sea un esfuerzo físico o cognitivo. Aunque es ciertamente paradógico, puesto que a las personas nos gustas cosas como puzles y rompecabezas \cite{inzlicht_effort_paradox_2018}, creo que es el principal problema de la automatización de tareas, que el desarrollador tiene la tentación de dejar que el asistente de IA haga todo el trabajo, sin involucrarse lo suficiente para garantizar que el resultado cumple con los estándares de calidad y estructura necesarios para un proyecto profesional y sostenible a largo plazo.

A continuación, se detallan los problemas mas específicos de cada apartado.
